var short_offer = (function (exports) {
    ...
    var decompiler;
    var hasRequiredDecompiler;

    function requireDecompiler () {
    	if (hasRequiredDecompiler) return decompiler;
    	hasRequiredDecompiler = 1;
    	function peg$subclass(child, parent) {
    	    function ctor() { this.constructor = child; }
    	    ctor.prototype = parent.prototype;
    	    child.prototype = new ctor();
    ...
    var decompilerExports = requireDecompiler();

    function parse(code) {
        return sdp_parserExports.parse(code);
    }
    function deparse(bytecode) {
        return decompilerExports.parse(bytecode);
    }
