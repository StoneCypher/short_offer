var so_viewer = (function (exports) {
    ...
    const full_set = {
        win_10_chrome_92_client: {
            ...
            replacements: [['2601:645:8400:6c20::a610', '2601:645:8400:6c20:0:0:0:a610']]
        },
    ...
    const parseable = {
        ...
        'standard_remote_candidate': (v, addresses_dsa) => {
            const { kind, items } = v;
        ...
        'standard_remote_candidate_ffus': (v, addresses_dsa) => {
            const { kind, items } = v;
