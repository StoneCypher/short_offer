...
function peg$parse$1(input, options) {
                                            ...
                                            if (s10 !== peg$FAILED) {
                                                ...
                                                if (s11 !== peg$FAILED) {
                                                    ...
                                                    if (s12 !== peg$FAILED) {
                                                        ...
                                                        if (s13 !== peg$FAILED) {
                                                            peg$savedPos = s0;
                                                            s1 = peg$c133(s2, s4, s6, s8, s10, s12);
                                                            s0 = s1;
                                                        }
                                                        else {
                                                            peg$currPos = s0;
    ...
    function peg$parseStandardMApplication() {
        ...
        if (s1 !== peg$FAILED) {
            s2 = peg$parseDecimal();
            if (s2 !== peg$FAILED) {
                if (input.substr(peg$currPos, 33) === peg$c152) {
                    s3 = peg$c152;
                    peg$currPos += 33;
                }
                else {
