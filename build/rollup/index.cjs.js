...
function peg$parse$1(input, options) {
    ...
    function peg$parseStandardMApplication() {
        ...
        if (s1 !== peg$FAILED) {
            s2 = peg$parseDecimal();
            if (s2 !== peg$FAILED) {
                if (input.substr(peg$currPos, 33) === peg$c151) {
                    s3 = peg$c151;
                    peg$currPos += 33;
                }
                else {
