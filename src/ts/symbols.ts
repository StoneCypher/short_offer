...
const offer                             = '\x01',
      ...
      standard_agen_udp4_candidate      = '\x18',
      standard_agen_udp6_host_candidate = '\x19',
      a_ice_pwd                         = '\x1a',
      a_ice_pwd_l                       = '\x1b',
      a_ice_ufrag                       = '\x1c',
      a_fingerprint_sha1_256            = '\x1d',
      a_group_bundle_0                  = '\x1e',
      a_send_recv                       = '\x1f',
      a_end_of_candidates               = '\x20',
      c_claim_ip4                       = '\x21',
      standard_m_application            = '\x22';
