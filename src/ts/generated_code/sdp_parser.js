...
function peg$parse(input, options) {
  ...
  var peg$FAILED = {},
      ...
      peg$startRuleFunctions = { RawDocument: peg$parseRawDocument, IP6N: peg$parseIP6N, AStandardTcpGuidLocalCandidateFfUSActive: peg$parseAStandardTcpGuidLocalCandidateFfUSActive },
      ...
      peg$c43 = "\"type\"",
      peg$c44 = peg$literalExpectation("\"type\"", false),
      peg$c45 = "\"offer\"",
      peg$c46 = peg$literalExpectation("\"offer\"", false),
      peg$c47 = ",",
      peg$c48 = peg$literalExpectation(",", false),
      peg$c49 = "\"sdp\"",
      peg$c50 = peg$literalExpectation("\"sdp\"", false),
      peg$c51 = "\"",
      peg$c52 = peg$literalExpectation("\"", false),
      peg$c53 = "}",
      peg$c54 = peg$literalExpectation("}", false),
      peg$c55 = function(s) { return ast('offer', s ); },
      peg$c56 = "\"answer\"",
      peg$c57 = peg$literalExpectation("\"answer\"", false),
      peg$c58 = function(s) { return ast('answer', s ); },
      peg$c59 = "v=0",
      peg$c60 = peg$literalExpectation("v=0", false),
      peg$c61 = function(us) { return ast('version_zero_line', undefined); },
      peg$c62 = "v=",
      peg$c63 = peg$literalExpectation("v=", false),
      peg$c64 = function(us) { return ast('version_line', us); },
      peg$c65 = "a=sendrecv",
      peg$c66 = peg$literalExpectation("a=sendrecv", false),
      peg$c67 = function(us) { return ast('a_send_recv', us); },
      peg$c68 = "b=AS:30",
      peg$c69 = peg$literalExpectation("b=AS:30", false),
      peg$c70 = function() { return ast('b_as_30'); },
      peg$c71 = "a=end-of-candidates",
      peg$c72 = peg$literalExpectation("a=end-of-candidates", false),
      peg$c73 = function(us) { return ast('a_end_of_candidates', us); },
      peg$c74 = "a=msid-semantic:WMS",
      peg$c75 = peg$literalExpectation("a=msid-semantic:WMS", false),
      peg$c76 = function() { return ast('a_msid_semantic_ns'); },
      peg$c77 = "a=msid-semantic:WMS *",
      peg$c78 = peg$literalExpectation("a=msid-semantic:WMS *", false),
      peg$c79 = function() { return ast('a_msid_semantic_star_ns'); },
      peg$c80 = "a=msid-semantic: WMS",
      peg$c81 = peg$literalExpectation("a=msid-semantic: WMS", false),
      peg$c82 = function() { return ast('a_msid_semantic_ws'); },
      peg$c83 = "a=extmap-allow-mixed",
      peg$c84 = peg$literalExpectation("a=extmap-allow-mixed", false),
      peg$c85 = function() { return ast('a_extmap_allow_mixed'); },
      peg$c86 = "a=setup:actpass",
      peg$c87 = peg$literalExpectation("a=setup:actpass", false),
      peg$c88 = function() { return ast('a_setup_actpass'); },
      peg$c89 = "a=setup:active",
      peg$c90 = peg$literalExpectation("a=setup:active", false),
      peg$c91 = function() { return ast('a_setup_active'); },
      peg$c92 = "a=mid:0",
      peg$c93 = peg$literalExpectation("a=mid:0", false),
      peg$c94 = function() { return ast('a_mid_zero'); },
      peg$c95 = "s=-",
      peg$c96 = peg$literalExpectation("s=-", false),
      peg$c97 = function() { return ast('s_dash'); },
      peg$c98 = function(maj, min, patch) { return ast('moz_v_num', [maj, min, patch]); },
      peg$c99 = function(maj, min) { return ast('moz_v_num', [maj, min, undefined]); },
      peg$c100 = "o=- ",
      peg$c101 = peg$literalExpectation("o=- ", false),
      peg$c102 = " ",
      peg$c103 = peg$literalExpectation(" ", false),
      peg$c104 = " IN IP4 ",
      peg$c105 = peg$literalExpectation(" IN IP4 ", false),
      peg$c106 = function(msess, d, i) { return ast('standard_origin', [msess, d, i], [i]); },
      peg$c107 = "o=mozilla...THIS_IS_SDPARTA-",
      peg$c108 = peg$literalExpectation("o=mozilla...THIS_IS_SDPARTA-", false),
      peg$c109 = " 0 IN IP4 0.0.0.0",
      peg$c110 = peg$literalExpectation(" 0 IN IP4 0.0.0.0", false),
      peg$c111 = function(mv, msess) { return ast('standard_moz_origin', [mv, msess]); },
      peg$c112 = "t=0 0",
      peg$c113 = peg$literalExpectation("t=0 0", false),
      peg$c114 = function() { return ast('t_zero_zero'); },
      peg$c115 = "a=ice-options:trickle",
      peg$c116 = peg$literalExpectation("a=ice-options:trickle", false),
      peg$c117 = function() { return ast('a_ice_options_trickle'); },
      peg$c118 = "a=sctp-port:5000",
      peg$c119 = peg$literalExpectation("a=sctp-port:5000", false),
      peg$c120 = function() { return ast('a_standard_sctp_port'); },
      peg$c121 = "a=sctp-port:",
      peg$c122 = peg$literalExpectation("a=sctp-port:", false),
      peg$c123 = function(data) { return ast('a_custom_sctp_port', data); },
      peg$c124 = "a=max-message-size:262144",
      peg$c125 = peg$literalExpectation("a=max-message-size:262144", false),
      peg$c126 = function() { return ast('a_standard_max_message_size'); },
      peg$c127 = "a=max-message-size:",
      peg$c128 = peg$literalExpectation("a=max-message-size:", false),
      peg$c129 = function(data) { return ast('a_custom_max_message_size', data); },
      peg$c130 = "a=candidate:",
      peg$c131 = peg$literalExpectation("a=candidate:", false),
      peg$c132 = " udp ",
      peg$c133 = peg$literalExpectation(" udp ", false),
      peg$c134 = " typ host generation 0 network-id ",
      peg$c135 = peg$literalExpectation(" typ host generation 0 network-id ", false),
      peg$c136 = function(d1, d2, d3, i, p, d4) { return ast('standard_local_candidate', [ d1, d2, d3, i, p, d4 ], [i]); },
      peg$c137 = ".local ",
      peg$c138 = peg$literalExpectation(".local ", false),
      peg$c139 = " typ host generation 0 network-cost 999",
      peg$c140 = peg$literalExpectation(" typ host generation 0 network-cost 999", false),
      peg$c141 = function(d1, d2, d3, g, d4) { return ast('standard_guid_local_candidate', [ d1, d2, d3, g, d4 ], undefined, [g]); },
      peg$c142 = " UDP ",
      peg$c143 = peg$literalExpectation(" UDP ", false),
      peg$c144 = " typ host",
      peg$c145 = peg$literalExpectation(" typ host", false),
      peg$c146 = function(d1, d2, d3, i, d4) { return ast('standard_ip6_local_candidate_ffus', [ d1, d2, d3, i, d4 ], undefined, [i]); },
      peg$c147 = " TCP ",
      peg$c148 = peg$literalExpectation(" TCP ", false),
      peg$c149 = " typ host tcptype active",
      peg$c150 = peg$literalExpectation(" typ host tcptype active", false),
      peg$c151 = function(d1, d2, d3, i, d4) { return ast('standard_ip6_local_candidate_ffus_active', [ d1, d2, d3, i, d4 ], undefined, [i]); },
      peg$c152 = function(d1, d2, d3, i, d4) { return ast('standard_ip4_local_candidate_ffus', [ d1, d2, d3, i, d4 ]); },
      peg$c153 = function(d1, d2, d3, i, d4) { return ast('standard_ip4_local_candidate_ffus_active', [ d1, d2, d3, i, d4 ]); },
      peg$c154 = function(d1, d2, d3, g, d4) { return ast('standard_tcp_guid_local_candidate_ffus_active', [ d1, d2, d3, g, d4 ], undefined, [g]); },
      peg$c155 = function(d1, d2, d3, g, d4) { return ast('standard_guid_local_candidate_ffus', [ d1, d2, d3, g, d4 ], undefined, [g]); },
      peg$c156 = " typ srflx raddr ",
      peg$c157 = peg$literalExpectation(" typ srflx raddr ", false),
      peg$c158 = " rport ",
      peg$c159 = peg$literalExpectation(" rport ", false),
      peg$c160 = " generation ",
      peg$c161 = peg$literalExpectation(" generation ", false),
      peg$c162 = " network-cost 999",
      peg$c163 = peg$literalExpectation(" network-cost 999", false),
      peg$c164 = function(d1, d2, d3, i1, d4, i2, d5, d6) { return ast('standard_remote_candidate', [ d1, d2, d3, i1, d4, i2, d5, d6 ], [i1, i2]); },
      peg$c165 = function(d1, d2, d3, i1, d4, i2, d5) { return ast('standard_remote_candidate_ffus', [ d1, d2, d3, i1, d4, i2, d5 ], [i1, i2]); },
      peg$c166 = " tcp ",
      peg$c167 = peg$literalExpectation(" tcp ", false),
      peg$c168 = " typ host tcptype active generation 0 network-id ",
      peg$c169 = peg$literalExpectation(" typ host tcptype active generation 0 network-id ", false),
      peg$c170 = function(d1, d2, d3, i1, d4, d5) { return ast('standard_agen_tcp_candidate', [ d1, d2, d3, i1, d4, d5 ], [i1]); },
      peg$c171 = function(d1, d2, d3, i1, d4, d5) { return ast('standard_agen_tcp6_candidate', [ d1, d2, d3, i1, d4, d5 ], undefined, [i1]); },
      peg$c172 = " generation 0 network-id ",
      peg$c173 = peg$literalExpectation(" generation 0 network-id ", false),
      peg$c174 = function(d1, d2, d3, i1, d4, i2, d5, d6) { return ast('standard_agen_udp4_candidate', [ d1, d2, d3, i1, d4, i2, d5, d6 ], [i1]); },
      peg$c175 = function(d1, d2, d3, i1, d4, d5) { return ast('standard_agen_udp6_host_candidate', [ d1, d2, d3, i1, d4, d5 ], undefined, [i1]); },
      peg$c176 = "a=ice-pwd:",
      peg$c177 = peg$literalExpectation("a=ice-pwd:", false),
      peg$c178 = function(data) { return ast('a_ice_pwd', data); },
      peg$c179 = function(data) { return ast('a_ice_pwd_l', data); },
      peg$c180 = function(data) { return ast('a_ice_pwd_v', data); },
      peg$c181 = "a=ice-ufrag:",
      peg$c182 = peg$literalExpectation("a=ice-ufrag:", false),
      peg$c183 = function(data) { return ast('a_ice_ufrag_4', data); },
      peg$c184 = "ice-ufrag:",
      peg$c185 = peg$literalExpectation("ice-ufrag:", false),
      peg$c186 = function(data) { return ast('falkon_a_ice_ufrag_4', data); },
      peg$c187 = function(data) { return ast('a_ice_ufrag_8', data); },
      peg$c188 = "a=fingerprint:sha-256 ",
      peg$c189 = peg$literalExpectation("a=fingerprint:sha-256 ", false),
      peg$c190 = function(data) { return ast('a_fingerprint_sha1_256', data); },
      peg$c191 = "a=group:BUNDLE 0",
      peg$c192 = peg$literalExpectation("a=group:BUNDLE 0", false),
      peg$c193 = function() { return ast('a_group_bundle_0'); },
      peg$c194 = "c=IN IP4 ",
      peg$c195 = peg$literalExpectation("c=IN IP4 ", false),
      peg$c196 = function(data) { return ast('c_claim_ip4', data, [data]); },
      peg$c197 = "m=application ",
      peg$c198 = peg$literalExpectation("m=application ", false),
      peg$c199 = " UDP/DTLS/SCTP webrtc-datachannel",
      peg$c200 = peg$literalExpectation(" UDP/DTLS/SCTP webrtc-datachannel", false),
      peg$c201 = function(data) { return ast('standard_m_application', data); },
      peg$c202 = function(us) { return ast('unknown_line', us); },
      peg$c203 = /^[^'\r\n']/,
      peg$c204 = peg$classExpectation(["'", "\r", "\n", "'"], true, false),
      peg$c205 = "\r\n",
      peg$c206 = peg$literalExpectation("\r\n", false),
      peg$c207 = function(rl) { return rl.join(''); },
      peg$c208 = peg$anyExpectation(),
      peg$c209 = function(uts) { return ast( 'unknown_terminate', uts.join('') ); },
