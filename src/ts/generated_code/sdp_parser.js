...
function peg$parse(input, options) {
  ...
  var peg$FAILED = {},
      ...
      peg$c80 = function() { return ast('a_msid_semantic_star_ns'); },
      peg$c81 = "a=msid-semantic: WMS",
      peg$c82 = peg$literalExpectation("a=msid-semantic: WMS", false),
      peg$c83 = function() { return ast('a_msid_semantic_ws'); },
      peg$c84 = "a=extmap-allow-mixed",
      peg$c85 = peg$literalExpectation("a=extmap-allow-mixed", false),
      peg$c86 = function() { return ast('a_extmap_allow_mixed'); },
      peg$c87 = "a=setup:actpass",
      peg$c88 = peg$literalExpectation("a=setup:actpass", false),
      peg$c89 = function() { return ast('a_setup_actpass'); },
      peg$c90 = "a=setup:active",
      peg$c91 = peg$literalExpectation("a=setup:active", false),
      peg$c92 = function() { return ast('a_setup_active'); },
      peg$c93 = "a=mid:0",
      peg$c94 = peg$literalExpectation("a=mid:0", false),
      peg$c95 = function() { return ast('a_mid_zero'); },
      peg$c96 = "s=-",
      peg$c97 = peg$literalExpectation("s=-", false),
      peg$c98 = function() { return ast('s_dash'); },
      peg$c99 = function(maj, min, patch) { return ast('moz_v_num', [maj, min, patch]); },
      peg$c100 = function(maj, min) { return ast('moz_v_num', [maj, min, undefined]); },
      peg$c101 = "o=- ",
      peg$c102 = peg$literalExpectation("o=- ", false),
      peg$c103 = " ",
      peg$c104 = peg$literalExpectation(" ", false),
      peg$c105 = " IN IP4 ",
      peg$c106 = peg$literalExpectation(" IN IP4 ", false),
      peg$c107 = function(msess, d, i) { return ast('standard_origin', [msess, d, i]); },
      peg$c108 = "o=mozilla...THIS_IS_SDPARTA-",
      peg$c109 = peg$literalExpectation("o=mozilla...THIS_IS_SDPARTA-", false),
      peg$c110 = " 0 IN IP4 0.0.0.0",
      peg$c111 = peg$literalExpectation(" 0 IN IP4 0.0.0.0", false),
      peg$c112 = function(mv, msess) { return ast('standard_moz_origin', [mv, msess]); },
      peg$c113 = "t=0 0",
      peg$c114 = peg$literalExpectation("t=0 0", false),
      peg$c115 = function() { return ast('t_zero_zero'); },
      peg$c116 = "a=sctp-port:5000",
      peg$c117 = peg$literalExpectation("a=sctp-port:5000", false),
      peg$c118 = function() { return ast('a_standard_sctp_port'); },
      peg$c119 = "a=sctp-port:",
      peg$c120 = peg$literalExpectation("a=sctp-port:", false),
      peg$c121 = function(data) { return ast('a_custom_sctp_port', data); },
      peg$c122 = "a=max-message-size:262144",
      peg$c123 = peg$literalExpectation("a=max-message-size:262144", false),
      peg$c124 = function() { return ast('a_standard_max_message_size'); },
      peg$c125 = "a=max-message-size:",
      peg$c126 = peg$literalExpectation("a=max-message-size:", false),
      peg$c127 = function(data) { return ast('a_custom_max_message_size', data); },
      peg$c128 = "a=candidate:",
      peg$c129 = peg$literalExpectation("a=candidate:", false),
      peg$c130 = " udp ",
      peg$c131 = peg$literalExpectation(" udp ", false),
      peg$c132 = " typ host generation 0 network-id ",
      peg$c133 = peg$literalExpectation(" typ host generation 0 network-id ", false),
      peg$c134 = function(d1, d2, d3, i, p, d4) { return ast('standard_local_candidate', [ d1, d2, d3, i, p, d4 ]); },
      peg$c135 = ".local ",
      peg$c136 = peg$literalExpectation(".local ", false),
      peg$c137 = " typ host generation 0 network-cost 999",
      peg$c138 = peg$literalExpectation(" typ host generation 0 network-cost 999", false),
      peg$c139 = function(d1, d2, d3, g, d4) { return ast('standard_guid_candidate', [ d1, d2, d3, g, d4 ]); },
      peg$c140 = " typ srflx raddr ",
      peg$c141 = peg$literalExpectation(" typ srflx raddr ", false),
      peg$c142 = " rport ",
      peg$c143 = peg$literalExpectation(" rport ", false),
      peg$c144 = " generation ",
      peg$c145 = peg$literalExpectation(" generation ", false),
      peg$c146 = " network-cost 999",
      peg$c147 = peg$literalExpectation(" network-cost 999", false),
      peg$c148 = function(d1, d2, d3, i1, d4, i2, d5, d6) { return ast('standard_remote_candidate', [ d1, d2, d3, i1, d4, i2, d5, d6 ]); },
      peg$c149 = " tcp ",
      peg$c150 = peg$literalExpectation(" tcp ", false),
      peg$c151 = " typ host tcptype active generation 0 network-id ",
      peg$c152 = peg$literalExpectation(" typ host tcptype active generation 0 network-id ", false),
      peg$c153 = function(d1, d2, d3, i1, d4, d5) { return ast('standard_agen_tcp_candidate', [ d1, d2, d3, i1, d4, d5 ]); },
      peg$c154 = function(d1, d2, d3, i1, d4, d5) { return ast('standard_agen_tcp6_candidate', [ d1, d2, d3, i1, d4, d5 ]); },
      peg$c155 = " generation 0 network-id ",
      peg$c156 = peg$literalExpectation(" generation 0 network-id ", false),
      peg$c157 = function(d1, d2, d3, i1, d4, i2, d5, d6) { return ast('standard_agen_udp4_candidate', [ d1, d2, d3, i1, d4, i2, d5, d6 ]); },
      peg$c158 = function(d1, d2, d3, i1, d4, d5) { return ast('standard_agen_udp6_host_candidate', [ d1, d2, d3, i1, d4, d5 ]); },
      peg$c159 = "a=ice-pwd:",
      peg$c160 = peg$literalExpectation("a=ice-pwd:", false),
      peg$c161 = function(data) { return ast('a_ice_pwd', data); },
      peg$c162 = function(data) { return ast('a_ice_pwd_l', data); },
      peg$c163 = "a=ice-ufrag:",
      peg$c164 = peg$literalExpectation("a=ice-ufrag:", false),
      peg$c165 = function(data) { return ast('a_ice_ufrag_4', data); },
      peg$c166 = function(data) { return ast('a_ice_ufrag_8', data); },
      peg$c167 = "a=fingerprint:sha-256 ",
      peg$c168 = peg$literalExpectation("a=fingerprint:sha-256 ", false),
      peg$c169 = function(data) { return ast('a_fingerprint_sha1_256', data); },
      peg$c170 = "a=group:BUNDLE 0",
      peg$c171 = peg$literalExpectation("a=group:BUNDLE 0", false),
      peg$c172 = function() { return ast('a_group_bundle_0'); },
      peg$c173 = "c=IN IP4 ",
      peg$c174 = peg$literalExpectation("c=IN IP4 ", false),
      peg$c175 = function(data) { return ast('c_claim_ip4', data); },
      peg$c176 = "m=application ",
      peg$c177 = peg$literalExpectation("m=application ", false),
      peg$c178 = " UDP/DTLS/SCTP webrtc-datachannel",
      peg$c179 = peg$literalExpectation(" UDP/DTLS/SCTP webrtc-datachannel", false),
      peg$c180 = function(data) { return ast('standard_m_application', data); },
      peg$c181 = function(us) { return ast('unknown_line', us); },
      peg$c182 = /^[^'\r\n']/,
      peg$c183 = peg$classExpectation(["'", "\r", "\n", "'"], true, false),
      peg$c184 = "\r\n",
      peg$c185 = peg$literalExpectation("\r\n", false),
      peg$c186 = function(rl) { return rl.join(''); },
      peg$c187 = peg$anyExpectation(),
      peg$c188 = function(uts) { return ast( 'unknown_terminate', uts.join('') ); },
