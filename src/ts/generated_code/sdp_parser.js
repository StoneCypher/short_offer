...
function peg$parse(input, options) {
  ...
  var peg$FAILED = {},
      ...
      peg$c141 = " typ srflx raddr ",
      peg$c142 = peg$literalExpectation(" typ srflx raddr ", false),
      peg$c143 = " rport ",
      peg$c144 = peg$literalExpectation(" rport ", false),
      peg$c145 = " generation ",
      peg$c146 = peg$literalExpectation(" generation ", false),
      peg$c147 = " network-cost 999",
      peg$c148 = peg$literalExpectation(" network-cost 999", false),
      peg$c149 = function(d1, d2, d3, i1, d4, i2, d5, d6) { return ast('standard_remote_candidate', [ d1, d2, d3, i1, d4, i2, d5, d6 ]); },
      peg$c150 = " tcp ",
      peg$c151 = peg$literalExpectation(" tcp ", false),
      peg$c152 = " typ host tcptype active generation 0 network-id ",
      peg$c153 = peg$literalExpectation(" typ host tcptype active generation 0 network-id ", false),
      peg$c154 = function(d1, d2, d3, i1, d4, d5) { return ast('standard_agen_tcp_candidate', [ d1, d2, d3, i1, d4, d5 ]); },
      peg$c155 = function(d1, d2, d3, i1, d4, d5) { return ast('standard_agen_tcp6_candidate', [ d1, d2, d3, i1, d4, d5 ]); },
      peg$c156 = " generation 0 network-id ",
      peg$c157 = peg$literalExpectation(" generation 0 network-id ", false),
      peg$c158 = function(d1, d2, d3, i1, d4, i2, d5, d6) { return ast('standard_agen_udp4_candidate', [ d1, d2, d3, i1, d4, i2, d5, d6 ]); },
      peg$c159 = function(d1, d2, d3, i1, d4, d5) { return ast('standard_agen_udp6_host_candidate', [ d1, d2, d3, i1, d4, d5 ]); },
      peg$c160 = "a=ice-pwd:",
      peg$c161 = peg$literalExpectation("a=ice-pwd:", false),
      peg$c162 = function(data) { return ast('a_ice_pwd', data); },
      peg$c163 = function(data) { return ast('a_ice_pwd_l', data); },
      peg$c164 = function(data) { return ast('a_ice_pwd_v', data); },
      peg$c165 = "a=ice-ufrag:",
      peg$c166 = peg$literalExpectation("a=ice-ufrag:", false),
      peg$c167 = function(data) { return ast('a_ice_ufrag_4', data); },
      peg$c168 = function(data) { return ast('a_ice_ufrag_8', data); },
      peg$c169 = "a=fingerprint:sha-256 ",
      peg$c170 = peg$literalExpectation("a=fingerprint:sha-256 ", false),
      peg$c171 = function(data) { return ast('a_fingerprint_sha1_256', data); },
      peg$c172 = "a=group:BUNDLE 0",
      peg$c173 = peg$literalExpectation("a=group:BUNDLE 0", false),
      peg$c174 = function() { return ast('a_group_bundle_0'); },
      peg$c175 = "c=IN IP4 ",
      peg$c176 = peg$literalExpectation("c=IN IP4 ", false),
      peg$c177 = function(data) { return ast('c_claim_ip4', data); },
      peg$c178 = "m=application ",
      peg$c179 = peg$literalExpectation("m=application ", false),
      peg$c180 = " UDP/DTLS/SCTP webrtc-datachannel",
      peg$c181 = peg$literalExpectation(" UDP/DTLS/SCTP webrtc-datachannel", false),
      peg$c182 = function(data) { return ast('standard_m_application', data); },
      peg$c183 = function(us) { return ast('unknown_line', us); },
      peg$c184 = /^[^'\r\n']/,
      peg$c185 = peg$classExpectation(["'", "\r", "\n", "'"], true, false),
      peg$c186 = "\r\n",
      peg$c187 = peg$literalExpectation("\r\n", false),
      peg$c188 = function(rl) { return rl.join(''); },
      peg$c189 = peg$anyExpectation(),
      peg$c190 = function(uts) { return ast( 'unknown_terminate', uts.join('') ); },
